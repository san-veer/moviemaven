...
export function SampleNextArrow(props) {
  ...
  return (
    <div
      className={className}
      style={{  height: 30, width: 30, borderRadius: 20, paddingTop: 5, marginRight: 20, backgroundColor: "black" }}
      onClick={onClick}
    />
  );
}
...
function Home() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://af2c-203-192-244-153.ngrok-free.app/api/v1/movies?page=1&page_size=20");
        const res2 = await axios.get("https://af2c-203-192-244-153.ngrok-free.app/api/v1/movies?page=2&page_size=20");
    ...
    <div>
      ...
      <div className="home" >
        ...
        { recommendation && recommendation.length !== 0 &&
          <div style={{marginBottom:60}} className="movie-list" >
            <Slider {...settings}>
